...
To put it more quantitatively: with a paid-to-imposed ratio of just 34% in 2018 but an 80% contribution to all penalty dollars imposed, `Construction` penalties in 2018 single-handedly account for the current (as of our analysis) *non-payment of 73% of all violation-dollars imposed that year*.
